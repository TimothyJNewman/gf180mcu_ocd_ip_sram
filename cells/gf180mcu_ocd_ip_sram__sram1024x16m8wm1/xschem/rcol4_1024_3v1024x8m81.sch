...
N -0 -170 10 -170 {lab=DRWL}
N -30 -170 -0 -170 {lab=DRWL}
...
C {rdummy_3v1024x4_3v1024x8m81.sym} 150 -110 0 0 {name=x2}
C {ipin.sym} -30 -170 0 0 {name=p20 lab=DRWL}
