 ...
 * Revision:		0.1
 *
 * Description:         gf180mcu_ocd_ip_sram__sram1024x16m8wm1 Simulation Model
 */
...
module gf180mcu_ocd_ip_sram__sram1024x16m8wm1 (
...
input   [15:0] 	WEN;    //Write Enable Negative
input   [9:0]   A;
input   [15:0] 	D;
output	[15:0]	Q;
`ifdef USE_POWER_PINS
...
//---- WEN[7:0] setup/hold timing
  ...
  $setup (negedge WEN[8],  posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[9],  posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[10], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[11], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[12], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[13], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[14], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (negedge WEN[15], posedge CLK &&& write_flag, twis, ntf_twis);
  ...
  $setup (posedge WEN[8],  posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[9],  posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[10], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[11], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[12], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[13], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[14], posedge CLK &&& write_flag, twis, ntf_twis);
  $setup (posedge WEN[15], posedge CLK &&& write_flag, twis, ntf_twis);
  ...
  $hold  (posedge CLK &&& write_flag, posedge WEN[8],  twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[9],  twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[10], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[11], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[12], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[13], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[14], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, posedge WEN[15], twih, ntf_twih);
  ...
  $hold  (posedge CLK &&& write_flag, negedge WEN[8],  twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[9],  twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[10], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[11], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[12], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[13], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[14], twih, ntf_twih);
  $hold  (posedge CLK &&& write_flag, negedge WEN[15], twih, ntf_twih);
...
//---- D[7:0] setup/hold timing
  ...
  $setup (posedge D[8],  posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[9],  posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[10], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[11], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[12], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[13], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[14], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (posedge D[15], posedge CLK &&& write_flag, tds, ntf_tds);
  ...
  $setup (negedge D[8],  posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[9],  posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[10], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[11], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[12], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[13], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[14], posedge CLK &&& write_flag, tds, ntf_tds);
  $setup (negedge D[15], posedge CLK &&& write_flag, tds, ntf_tds);
  ...
  $hold  (posedge CLK &&& write_flag, negedge D[8],  tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[9],  tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[10], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[11], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[12], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[13], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[14], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, negedge D[15], tdh, ntf_tdh);
  ...
  $hold  (posedge CLK &&& write_flag, posedge D[8],  tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[9],  tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[10], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[11], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[12], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[13], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[14], tdh, ntf_tdh);
  $hold  (posedge CLK &&& write_flag, posedge D[15], tdh, ntf_tdh);

//---- Output delay
// rise transition:     0->1, z->1, Ta
// fall transition:     1->0, 1->z, Ta
// turn-off transition: 0->z, 1->z, Tcqx
//if (!CEN & GWEN) (posedge CLK => (Q : 16'bx)) = (Ta, Ta, Tcqx);
...
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[8]  : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[9]  : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[10] : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[11] : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[12] : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[13] : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[14] : 1'bx)) = (ta, ta);
if ((CEN == 1'b0) && (GWEN == 1'b1)) (posedge CLK => (Q[15] : 1'bx)) = (ta, ta);
endspecify
...
always @(posedge CLK) cdx = {16{1'bx}} & we;    //latch cdx
...
always @(negedge clk_dly) begin         	//invalidate write/read when hold/clk viol
  if (no_hd_viol == 0 | no_ck_viol == 0) begin
    if (write_flag_dly) begin
      if (ntf_twh) begin
        mem[marked_a] = mem[marked_a] ^ 16'bx; //GWEN can't be used to generate cdx
        qo_reg        = qo_reg ^ 16'bx;
      end
      else begin
